...
private:
    void updateCameraVectors(){
        ...
        Right = glm::normalize(glm::cross(Front, WorldUp));  //normalize the vectors, because their length gets closer to 0 the more you look up or down which results into slower movement.
